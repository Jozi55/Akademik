...
@section('heading', 'Edit Data Keterampilan')
@section('page')
  <li class="breadcrumb-item active">Edit Data Keterampilan</li>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-md-12">
                    <form action="{{route('update-keterampilan')}}" method="POST">
                        @csrf
                        {{ method_field('PATCH') }}
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                            ...
                                            @else
                                            <input type="text" name="kd" class="form-control" value="{{$kt->kd}}">
                                            @endif
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table id="example3" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody class="scrol">
                                @foreach ($keterampilan as $item)
                                    <tr>
                                        <input type="hidden" name="keterampilan_id[]" value="{{$item->id}}">
