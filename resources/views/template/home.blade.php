        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                @if (Auth::user()->role == "admin")
                    <li class="breadcrumb-item"><a href="/admin"><i class="nav-icon fas fa-home"></i> &nbsp; Home</a></li>
                @else
                    <li class="breadcrumb-item"><a href="/home"><i class="nav-icon fas fa-home"></i> &nbsp; Home</a></li>
                @endif
                @yield('page')
                </ol>
            </div><!-- /.col -->
